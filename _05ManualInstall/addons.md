...
Install these categories between "Utilities" and "Conflict Resolution".  Each addon is optional, but all of a specific addon must be installed for consistency, unless noted by an ![Optional] tag.
...
[![mod]](https://www.nexusmods.com/skyrimspecialedition/mods/116522) | Version: `2.07` | Author: `jayserpa` | ![Optional] ![CAO]
